...
const singleData=[{ "id": 1, "title": "iPhone 9", "description": "An apple mobile which is nothing like apple", "price": 549, "discountPercentage": 12.96, "rating": 4.69, "stock": 94,  }]
...
router.get('/:id',(req,res)=>{
    ...
    res.send({message:'Fetch single Data',singleData:singleData[0]})
})
